...
if intro == "yes":
    ...
    print()
    print("Choose a Number of Rounds to Play or Press <Enter> for Endless mode\n\nEach Round Pick From Rock / Paper / Scissors (Or xxx To End The Program)\nYou Can Type r / p / s / x for efficiency\n\x1b[92mGreen Highlight = Win\x1b[96m, \x1b[93mYellow = Tie\x1b[96m, \x1b[91mRed = Lost\x1b[96m")
    print()
    decorator("Rules", "~", "1")
    print("- Rock Smashes Scissors")
    print("- Scissors Cuts Papers")
